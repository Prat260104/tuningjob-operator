...
var _ = BeforeSuite(func() {
	...
	var err error
	err = tuningv1alpha1.AddToScheme(scheme.Scheme)
	...
	By("creating manager with field indexer")
	...
	err = mgr.GetFieldIndexer().IndexField(ctx, &batchv1.Job{}, ".metadata.controller", indexFunc)
	Expect(err).NotTo(HaveOccurred())
